<h1 align="center"> 
  ✔️App Mata Mosquito✔️
</h1>

## 💻 Sobre o projeto

Jogo desenvolvido para fins de aprendizagem em JavaScript.

## :dart: Objetivo do Projeto

```bash
Praticar conhecimentos sobre em JavaScript

-Explorar a utilização de interação da pagina com JS;
-Aprimorar os conhecimentos sobre estrutura de repetição;
-Aprimorar os conhecimentos sobre funções;
-Aprimorar os conhecimentos sobre condicionais;
...
Para visualizar o site no GitHubPages <a href="https://cleuber-andrade.github.io/projeto_mata_mosquito/inicio_jogo.html" target="_blank">Clique aqui</a>

## 👷 Como rodar

```bash
# Clonar o repositório
git clone https://github.com/cleuber-andrade/projeto_mata_mosquito.git
